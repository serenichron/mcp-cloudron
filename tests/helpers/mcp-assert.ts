 ...
 */
export function assertHasContent(response: any) {
 ...
 */
export function assertHasTextContent(response: any) {
 ...
 */
export function assertError(response: any, expectedErrorMessage?: string) {
  assertValidMCPResponse(response);
 ...
 */
export function assertJSONContent(response: any) {
 ...
 */
export function assertArrayResponse(response: any, minLength = 0) {
 ...
 */
export function assertObjectResponse(response: any) {
  const data = assertJSONContent(response);
 ...
 */
export function assertArrayItemsHaveProperties(items: any[], properties: string[]) {
